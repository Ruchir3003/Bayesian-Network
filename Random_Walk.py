# This code runs the random walk algorithm. 
# The formula for random walk is derived from https://arxiv.org/pdf/2008.03639.pdf

# Input : The input parameters are : 
# a) Initial probability vector - Numpy Array
# b) Adjacency matrix - Numpy Array
# c) Steps of random walk - Integer
# Output : Final Probability vector - Numpy array

import numpy as np

def random_walk(initial_prob,adjacency_matrix, steps=10e5):
    ...
    if(A_rows == A_columns):
        ...
        while True : 
            pt_1= (M.transpose())@pt # pt+1 is the probability vector at t+1 time
