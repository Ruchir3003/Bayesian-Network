# This script is to run a random walk on a weighted graph (edges are weighted). 

# Inputs : a) Inital probability vector b) Edge Weights c) Steps os the random walk
# Output : Final Probability vector - Numpy array

import numpy as np

def random_walk_weighted (initial_prob, edge_weights, steps=10e5):
    ...
    while True : 
        pt_1= (transition_matrix.transpose())@pt # pt+1 is the probability vector at t+1 time
